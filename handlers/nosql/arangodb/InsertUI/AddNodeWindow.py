...
class AddNodeWindow(QDialog):
    def __init__(self, parent, clb, collection_names):
        ...
        self.collectionName.setCurrentText(collection_names[0])
    ...
    def save(self):
        ...
        newObject = {
            ...
            'document': {'_key': items['_key'], **items['document']} if items['_key'] else items['document']
        }    
