...
class NewArangoDbConnectionWindow(QDialog):
    def __init__(self, parent):
        ...
        self._connection = ArangoDBConnection()
        self._protocols = {
            0: 'http',
            1: 'https'
        }

        self.setWindowTitle("Create new ArangoDB Connection")
        ...
        self.parametersGridLayout.addWidget(QLabel("Username : ", self), 3, 0, Qt.AlignRight)
        self.parametersGridLayout.addWidget(self.user_i, 3, 1)
        self.parametersGridLayout.addWidget(DescriptionLabel("Name of the user to connect with : ", self), 3, 3)
    ...
    def _set_conn_params(self, conn: MongoDbConnection):
        ...
        self.protocl_i.setCurrentIndex(0 if conn.protocol == 'http' else 1)
