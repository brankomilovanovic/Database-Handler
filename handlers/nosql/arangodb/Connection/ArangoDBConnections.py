...
class ArangoDBConnections(Connections):
    __instance = None

    def __new__(cls):
        if ArangoDBConnections.__instance is None:
            connections = super(ArangoDBConnections, cls).__new__(cls)

            ArangoDBConnections.__instance = connections
            ...
            try:
                ...
                connections._load_connections()
        return ArangoDBConnections.__instance
    ...
    def _set_up(self, _connections: list[dict]) -> None:
        ...
        for connection in _connections:
            self.stored_connections.append(ArangoDBConnection(connection))
    ...
    @multimethod
    def save(self, conn: ArangoDBConnection) -> bool:
        """
    ...
    def save_as(self, conn: ArangoDBConnection):
