...
from handlers.nosql.mongodb.Connection.UI.NewMongoDbConnectionWindow import NewMongoDbConnectionWindow
from ui.menubar.MenuBar import MenuBar
from ui.window.MainWindow import MainWindow


class MongoDbConnectionHandler(Plugin):
    def activate(self) -> bool:
        self.connection_menu = self.menubar.set_menu("Connection")

        self.mysql_menu = QMenu('MongoDb', self.connection_menu)
    ...
    def connect(self):
        NewMongoDbConnectionWindow(MainWindow.instance())
